...
girl_seq_rects_wcrt = []  # To store the template patch coordinates
girl_seq_rects_wcrt.append(rect)
...
girl_seq_rects_wcrt = np.array(girl_seq_rects_wcrt)
np.save("girlseqrects-wcrt.npy", girl_seq_rects_wcrt)
